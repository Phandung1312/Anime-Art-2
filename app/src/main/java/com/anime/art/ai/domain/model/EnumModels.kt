...
enum class ArtStyle(val artStyleName : String, val sourceImage : String,val  model :String){
    ...
    ZFlighters(artStyleName = "Z Flighters", sourceImage = "z_flighters", model = "mo-di-diffusion"),
    PastelColors(artStyleName = "Pastel Colors", sourceImage = "pastel_colors", model = "synthwave-punk-v2"),
    Ninja(artStyleName = "Ninja", sourceImage = "ninja", model = "icbinp-relapse"),
    FantasicJOJO(artStyleName = "Fantasic JOJO", sourceImage = "fantasic_jojo", model = "analog-diffusion"),
    Tarot(artStyleName = "Tarot", sourceImage = "tarot", model = "moonfilm-reality-v3"),
    NinetyComic(artStyleName = "90s Comic", sourceImage = "_90s_comic", model = "dark-sushi-mix-v2-25"),
    ColorIllustration(artStyleName = "Color Illustration", sourceImage = "color_illustration", model = "neverending-dream"),
    GameCG(artStyleName = "Game CG", sourceImage = "game_cg", model = "arcane-diffusion"),
    ...
    InkAndWask(artStyleName = "Ink And Wask", sourceImage = "ink_and_wask", model = "icbinp"),
